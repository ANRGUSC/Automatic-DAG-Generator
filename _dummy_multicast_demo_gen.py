...
def update_dag(cur_dag,dup_task,num_org,multicast,new_dag_path_plot,first_task_list,last_task):		
	...
	if dup_task in new_dag.nodes():
		...
		if dup_task ==last_task:
			...
			new_dag.node['aggregate']['comp'] = SNUM	
...
def gen_updated_app(dummy_duplicate_root,args,num_org,dup_task,dag,multicast,last_task,first_task_list):
...
def gen_updated_demo(dummy_duplicate_root,args,num_org,dup_task,dag,multicast,last_task,first_task_list):
...
if __name__ == '__main__':
	...
	print('First task list')
	print(first_task_list)
	...
	# 	new_dag, new_multicast = gen_updated_app(dummy_duplicate_root,args,num_org,dup_task,dag_list[prev_task],multicast_list[prev_task],last_task,first_task_list)
	# 	dag_list[dup_task] = new_dag
	# 	multicast_list[dup_task] = new_multicast
	# 	prev_task = dup_task
